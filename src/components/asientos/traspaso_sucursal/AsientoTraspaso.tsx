...
const AsientoTraspaso = () => {
    const tipoAsiento = "Traspaso para abrir sucursal";
    ...
    return (
        <div className="h-[64.2vh] w-full bg-gray-100">
            ...
            <div className="bg-white p-6 rounded-md shadow-md">
                ...
                <div className="w-full flex items-center text-center justify-between mb-4">
                    <h2 className="text-lg font-semibold mb-4 text-center">Traspaso para abrir sucursal</h2>
                    <button
...
export default AsientoTraspaso;
